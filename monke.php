...
<html lang="en">
    ...
    <body onload="games();">
        ...
        <form action="./score.php" method="GET" id="form_id" style="display: none;">
        ...
        <div class="d-flex justify-content-center align-items-center" style="width: 100vw; height: 100vh; position: fixed;">
                ...
                <div class="row d-md-flex flex-md-row justify-content-md-between flex-md-nowrap d-flex flex-column align-content-around addopacitymonkey">
                    <div class="col-md-6 col-12 col-sm-12 d-flex justify-content-end justify-content-md-start m-0 p-0 order-md-1" id="assets-container-bot">
                        ...
                        <div class="col-md-3 col-4 d-flex flex-column justify-content-center m-1 p-0 order-md-2" id="botbuttons">
                            <button class="btn btn-primary mt-2 btn-sm" style="font-size: 0.8rem;">THROW CARD</button>
                            <button class="btn btn-success mt-2 btn-sm" style="font-size: 0.8rem;">FREE THROW</button>
                            <button class="btn btn-warning mt-2 btn-sm" style="font-size: 0.8rem;">MONKE</button>
                            <button class="btn btn-danger mt-2 btn-sm" style="font-size: 0.8rem;">END TURN</button>
